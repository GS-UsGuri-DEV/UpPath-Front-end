    ...
    <section className="rounded-xl border bg-white p-4">
      ...
      <div className="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="col-span-1 flex items-center gap-4">
          <div className="flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-r from-yellow-300 to-red-400 text-2xl font-bold text-white">
            {badge.emoji}
          </div>
          <div>
            ...
            <div className="mt-2 text-sm">
              🔥 {streak} dia{streak !== 1 ? 's' : ''} consecutivo
            </div>
          </div>
        </div>
